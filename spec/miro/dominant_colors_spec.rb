  ...
  context "colors_group method" do
    ...
    let(:pixel_data) do
      [2_678_156_287,
       ...
       740_104_447, 740_104_447, 740_104_447, 740_104_447, 740_104_447, 740_104_447, 740_104_447]
    end
    ...
    let(:expected_hex_values) { %w[#51332a #2c1d18 #6c4937 #65514a #95644f #e0e7dc #a34d3a #9fa16b"] }
    let(:expected_rgba_values) do
      [[81, 51, 42, 255], [44, 29, 24, 255], [108, 73, 55, 255], [101, 81, 74, 255], [149, 100, 79, 255],
       [224, 231, 220, 255], [163, 77, 58, 255], [159, 161, 107, 255]]
    end
